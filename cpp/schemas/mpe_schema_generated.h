...
#ifndef FLATBUFFERS_GENERATED_MPESCHEMA_MPE_H_
#define FLATBUFFERS_GENERATED_MPESCHEMA_MPE_H_
...
struct MPE FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  /// Unique ID as a String [no units] - typically NORAD CAT ID
  ...
  mpe::meanElementTheory MEAN_ELEMENT_THEORY() const {
    return static_cast<mpe::meanElementTheory>(GetField<int8_t>(VT_MEAN_ELEMENT_THEORY, 0));
  }
...
struct MPEBuilder {
  ...
  void add_MEAN_ELEMENT_THEORY(mpe::meanElementTheory MEAN_ELEMENT_THEORY) {
...
inline ::flatbuffers::Offset<MPE> CreateMPE(
    ...
    double BSTAR = 0.0,
    mpe::meanElementTheory MEAN_ELEMENT_THEORY = mpe::meanElementTheory_SGP4) {
...
inline const mpe::MPE *GetMPE(const void *buf) {
  return ::flatbuffers::GetRoot<mpe::MPE>(buf);
}

inline const mpe::MPE *GetSizePrefixedMPE(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<mpe::MPE>(buf);
}
...
inline bool VerifyMPEBuffer(
  ...
  return verifier.template VerifyBuffer<mpe::MPE>(MPEIdentifier());
}

template <bool B = false>
inline bool VerifySizePrefixedMPEBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<mpe::MPE>(MPEIdentifier());
}

inline void FinishMPEBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<mpe::MPE> root) {
...
#endif  // FLATBUFFERS_GENERATED_MPESCHEMA_MPE_H_
