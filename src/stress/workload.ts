...
export const DEFAULT_USE_CASES: StressUseCase[] = [
  {
    id: 'schema-sweep',
...
export function normalizeStressRunConfig(config: StressRunConfig = {}): NormalizedStressRunConfig {
...
export function buildNodeAssignments(
  schemas: readonly SdsSchemaInfo[],
  config: Pick<NormalizedStressRunConfig, 'nodeCount' | 'nodeIdOffset' | 'nodeStorageGb'>
): NodeAssignment[] {
